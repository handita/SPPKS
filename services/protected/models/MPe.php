 ...
 * @property MPe $kodeKortim
 * @property MPe[] $mPetugases
 * @property TRt[] $tRts
 */
class MPe extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MPe the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'kodeKortim' => array(self::BELONGS_TO, 'MPe', 'kode_kortim'),
			'mPetugases' => array(self::HAS_MANY, 'MPe', 'kode_kortim'),
